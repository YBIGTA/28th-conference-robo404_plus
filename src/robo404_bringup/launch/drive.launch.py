...
def generate_launch_description():
    micro_ros_agent_launch = _own_launch_file("micro_ros_agent.launch.py")
    ...
    return LaunchDescription(
        [
            ...
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(micro_ros_agent_launch),
                condition=IfCondition(use_micro_ros_agent),
                launch_arguments={
                    "agent_serial_device": micro_ros_serial_device,
                }.items(),
            ),
            Node(
                package="follower",
