    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                "top_sensor_id",
                default_value="1",
                description="Accepted for compatibility; ignored in single-camera mode.",
            ),
            DeclareLaunchArgument(
                "camera_sensor_id",
                default_value=LaunchConfiguration("bottom_sensor_id"),
            ),
            ...
            DeclareLaunchArgument(
                "micro_ros_serial_device", default_value="/dev/ttyACM0"
            ),
            DeclareLaunchArgument(
            ...
            IncludeLaunchDescription(
                ...
                launch_arguments={
                    ...
                    "micro_ros_serial_device": LaunchConfiguration(
