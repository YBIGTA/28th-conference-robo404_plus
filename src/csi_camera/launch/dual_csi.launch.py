...
def generate_launch_description():
    ...
    enable_top_camera = LaunchConfiguration("enable_top_camera")

    return LaunchDescription(
        [
            DeclareLaunchArgument("bottom_sensor_id", default_value="0"),
            DeclareLaunchArgument("top_sensor_id", default_value="1"),
            DeclareLaunchArgument("enable_top_camera", default_value="False"),
            ...
            Node(
                ...
                name="top_camera",
                output="screen",
                condition=IfCondition(enable_top_camera),
                parameters=[
                    _camera_parameters(
                        top_sensor_id,
                        top_flip_method,
